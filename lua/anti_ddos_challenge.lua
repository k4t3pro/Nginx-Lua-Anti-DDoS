...
https://github.com/k4t3pro/Nginx-Lua-Anti-DDoS
...
If you have any bugs issues or problems just post a Issue request. https://github.com/k4t3pro/Nginx-Lua-Anti-DDoS/issues

If you fork or make any changes to improve this or fix problems please do make a pull request for the community who also use this. https://github.com/k4t3pro/Nginx-Lua-Anti-DDoS/pulls
...
<a href="//facebook.com/k4t3pro" target="_blank">DDoS protection by &copy; Conor McKnight</a>
</div>
]]
...
ngx.header["Expires"] = "0"
if credits == 1 then
ngx.header["X-Anti-DDoS"] = "Conor McKnight | facebook.com/k4t3pro"
end
ngx.header.content_type = "text/html; charset=" .. default_charset
